...
class FacultiesController extends AppController
{
    ...
    public function add()
    {
        ...
        $facultiesTable = TableRegistry::getTableLocator()->get('Faculties');

        $faculties = $facultiesTable->find('list', [
            'keyField' => 'faculty_name',
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('Unable to save the faculty.'));
        }
    ...
    public function delete($id = null)
    {
        ...
        $lecturersTable->deleteAll(['faculty_id' => $faculty->faculty_id]);
