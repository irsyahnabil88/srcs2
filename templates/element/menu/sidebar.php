    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <li class="menu-header fw-bold text-uppercase mt-4 mb-3">
                <span class="menu-header-text ps-4">Academic</span>
                <div class="tricolor_line mb-3"></div>
            </li>
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-university"></i> Faculties'), ['controller' => 'Faculties', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-calendar-days"></i> Semesters'), ['controller' => 'Semesters', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-clipboard-list"></i> Registrations'), ['controller' => 'Registrations', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <?php if ($this->Identity->isLoggedIn()) { ?>
