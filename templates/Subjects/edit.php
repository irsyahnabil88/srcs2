	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $subject->subject_id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
    ...
    <div class="card-body text-body-secondary">
            ...
            <fieldset>
                <legend><?= __('Edit Subject') ?></legend>
                    ...
                    <?php echo $this->Form->control('lecturer_id', ['options' => $lecturers]); ?>
